...
namespace DevEdu_project.Figure
{
...

    {
        ...
        public override void WidthLine()
        {
            ...
            lineWidth.LWidth(new Point(x1, y1), new Point((x0 - (x1 - x0)), y1), _linewWidth, _colorLine);
            lineWidth.LWidth(new Point((x0 - (x1 - x0)), y1), new Point(x0, y0), _linewWidth, _colorLine);
